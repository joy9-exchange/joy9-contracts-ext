...
contract IDO is ReentrancyGuard, Ownable {
    ...
    event TokensPurchased(address buyer, uint256 usdcAmount, uint256 joy9Amount);
    ...
    function claimTokens() external nonReentrant {
        ...
        joy9Token.safeTransfer(msg.sender, tokensToClaim);
    }
    ...
    function withdrawTokens() external nonReentrant onlyOwner {
        require(block.timestamp >= endTime, "IDO not end");
        uint256 balance = joy9Token.balanceOf(address(this));
        joy9Token.safeTransfer(msg.sender, balance);
    }
}
